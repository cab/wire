...
annotation class WireField(
        ...
        val tag: Int,
        /**
         * Reference to the static field that holds a [ProtoAdapter] that can encode and decode
        ...
        val adapter: String,
        /**
         * The field's protocol buffer label, one of [Label.OPTIONAL],
         * [Label.REQUIRED], [Label.REPEATED], or [Label.PACKED].
         * Defaults to [Label.OPTIONAL].
         */
