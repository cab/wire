...
public final class AllTypes extends Message<AllTypes, AllTypes.Builder> {
  ...
  public AllTypes(Builder builder, ByteString unknownFields) {
    ...
    this.rep_int32 = Internal.INSTANCE.immutableCopyOf("rep_int32", builder.rep_int32);
    this.rep_uint32 = Internal.INSTANCE.immutableCopyOf("rep_uint32", builder.rep_uint32);
    this.rep_sint32 = Internal.INSTANCE.immutableCopyOf("rep_sint32", builder.rep_sint32);
    this.rep_fixed32 = Internal.INSTANCE.immutableCopyOf("rep_fixed32", builder.rep_fixed32);
    this.rep_sfixed32 = Internal.INSTANCE.immutableCopyOf("rep_sfixed32", builder.rep_sfixed32);
    this.rep_int64 = Internal.INSTANCE.immutableCopyOf("rep_int64", builder.rep_int64);
    this.rep_uint64 = Internal.INSTANCE.immutableCopyOf("rep_uint64", builder.rep_uint64);
    this.rep_sint64 = Internal.INSTANCE.immutableCopyOf("rep_sint64", builder.rep_sint64);
    this.rep_fixed64 = Internal.INSTANCE.immutableCopyOf("rep_fixed64", builder.rep_fixed64);
    this.rep_sfixed64 = Internal.INSTANCE.immutableCopyOf("rep_sfixed64", builder.rep_sfixed64);
    this.rep_bool = Internal.INSTANCE.immutableCopyOf("rep_bool", builder.rep_bool);
    this.rep_float = Internal.INSTANCE.immutableCopyOf("rep_float", builder.rep_float);
    this.rep_double = Internal.INSTANCE.immutableCopyOf("rep_double", builder.rep_double);
    this.rep_string = Internal.INSTANCE.immutableCopyOf("rep_string", builder.rep_string);
    this.rep_bytes = Internal.INSTANCE.immutableCopyOf("rep_bytes", builder.rep_bytes);
    this.rep_nested_enum = Internal.INSTANCE.immutableCopyOf("rep_nested_enum", builder.rep_nested_enum);
    this.rep_nested_message = Internal.INSTANCE.immutableCopyOf("rep_nested_message", builder.rep_nested_message);
    this.pack_int32 = Internal.INSTANCE.immutableCopyOf("pack_int32", builder.pack_int32);
    this.pack_uint32 = Internal.INSTANCE.immutableCopyOf("pack_uint32", builder.pack_uint32);
    this.pack_sint32 = Internal.INSTANCE.immutableCopyOf("pack_sint32", builder.pack_sint32);
    this.pack_fixed32 = Internal.INSTANCE.immutableCopyOf("pack_fixed32", builder.pack_fixed32);
    this.pack_sfixed32 = Internal.INSTANCE.immutableCopyOf("pack_sfixed32", builder.pack_sfixed32);
    this.pack_int64 = Internal.INSTANCE.immutableCopyOf("pack_int64", builder.pack_int64);
    this.pack_uint64 = Internal.INSTANCE.immutableCopyOf("pack_uint64", builder.pack_uint64);
    this.pack_sint64 = Internal.INSTANCE.immutableCopyOf("pack_sint64", builder.pack_sint64);
    this.pack_fixed64 = Internal.INSTANCE.immutableCopyOf("pack_fixed64", builder.pack_fixed64);
    this.pack_sfixed64 = Internal.INSTANCE.immutableCopyOf("pack_sfixed64", builder.pack_sfixed64);
    this.pack_bool = Internal.INSTANCE.immutableCopyOf("pack_bool", builder.pack_bool);
    this.pack_float = Internal.INSTANCE.immutableCopyOf("pack_float", builder.pack_float);
    this.pack_double = Internal.INSTANCE.immutableCopyOf("pack_double", builder.pack_double);
    this.pack_nested_enum = Internal.INSTANCE.immutableCopyOf("pack_nested_enum", builder.pack_nested_enum);
    ...
    this.map_int32_int32 = Internal.INSTANCE.immutableCopyOf("map_int32_int32", builder.map_int32_int32);
    this.map_string_string = Internal.INSTANCE.immutableCopyOf("map_string_string", builder.map_string_string);
    this.map_string_message = Internal.INSTANCE.immutableCopyOf("map_string_message", builder.map_string_message);
    this.map_string_enum = Internal.INSTANCE.immutableCopyOf("map_string_enum", builder.map_string_enum);
    ...
    this.ext_rep_int32 = Internal.INSTANCE.immutableCopyOf("ext_rep_int32", builder.ext_rep_int32);
    this.ext_rep_uint32 = Internal.INSTANCE.immutableCopyOf("ext_rep_uint32", builder.ext_rep_uint32);
    this.ext_rep_sint32 = Internal.INSTANCE.immutableCopyOf("ext_rep_sint32", builder.ext_rep_sint32);
    this.ext_rep_fixed32 = Internal.INSTANCE.immutableCopyOf("ext_rep_fixed32", builder.ext_rep_fixed32);
    this.ext_rep_sfixed32 = Internal.INSTANCE.immutableCopyOf("ext_rep_sfixed32", builder.ext_rep_sfixed32);
    this.ext_rep_int64 = Internal.INSTANCE.immutableCopyOf("ext_rep_int64", builder.ext_rep_int64);
    this.ext_rep_uint64 = Internal.INSTANCE.immutableCopyOf("ext_rep_uint64", builder.ext_rep_uint64);
    this.ext_rep_sint64 = Internal.INSTANCE.immutableCopyOf("ext_rep_sint64", builder.ext_rep_sint64);
    this.ext_rep_fixed64 = Internal.INSTANCE.immutableCopyOf("ext_rep_fixed64", builder.ext_rep_fixed64);
    this.ext_rep_sfixed64 = Internal.INSTANCE.immutableCopyOf("ext_rep_sfixed64", builder.ext_rep_sfixed64);
    this.ext_rep_bool = Internal.INSTANCE.immutableCopyOf("ext_rep_bool", builder.ext_rep_bool);
    this.ext_rep_float = Internal.INSTANCE.immutableCopyOf("ext_rep_float", builder.ext_rep_float);
    this.ext_rep_double = Internal.INSTANCE.immutableCopyOf("ext_rep_double", builder.ext_rep_double);
    this.ext_rep_string = Internal.INSTANCE.immutableCopyOf("ext_rep_string", builder.ext_rep_string);
    this.ext_rep_bytes = Internal.INSTANCE.immutableCopyOf("ext_rep_bytes", builder.ext_rep_bytes);
    this.ext_rep_nested_enum = Internal.INSTANCE.immutableCopyOf("ext_rep_nested_enum", builder.ext_rep_nested_enum);
    this.ext_rep_nested_message = Internal.INSTANCE.immutableCopyOf("ext_rep_nested_message", builder.ext_rep_nested_message);
    this.ext_pack_int32 = Internal.INSTANCE.immutableCopyOf("ext_pack_int32", builder.ext_pack_int32);
    this.ext_pack_uint32 = Internal.INSTANCE.immutableCopyOf("ext_pack_uint32", builder.ext_pack_uint32);
    this.ext_pack_sint32 = Internal.INSTANCE.immutableCopyOf("ext_pack_sint32", builder.ext_pack_sint32);
    this.ext_pack_fixed32 = Internal.INSTANCE.immutableCopyOf("ext_pack_fixed32", builder.ext_pack_fixed32);
    this.ext_pack_sfixed32 = Internal.INSTANCE.immutableCopyOf("ext_pack_sfixed32", builder.ext_pack_sfixed32);
    this.ext_pack_int64 = Internal.INSTANCE.immutableCopyOf("ext_pack_int64", builder.ext_pack_int64);
    this.ext_pack_uint64 = Internal.INSTANCE.immutableCopyOf("ext_pack_uint64", builder.ext_pack_uint64);
    this.ext_pack_sint64 = Internal.INSTANCE.immutableCopyOf("ext_pack_sint64", builder.ext_pack_sint64);
    this.ext_pack_fixed64 = Internal.INSTANCE.immutableCopyOf("ext_pack_fixed64", builder.ext_pack_fixed64);
    this.ext_pack_sfixed64 = Internal.INSTANCE.immutableCopyOf("ext_pack_sfixed64", builder.ext_pack_sfixed64);
    this.ext_pack_bool = Internal.INSTANCE.immutableCopyOf("ext_pack_bool", builder.ext_pack_bool);
    this.ext_pack_float = Internal.INSTANCE.immutableCopyOf("ext_pack_float", builder.ext_pack_float);
    this.ext_pack_double = Internal.INSTANCE.immutableCopyOf("ext_pack_double", builder.ext_pack_double);
    this.ext_pack_nested_enum = Internal.INSTANCE.immutableCopyOf("ext_pack_nested_enum", builder.ext_pack_nested_enum);
    this.ext_map_int32_int32 = Internal.INSTANCE.immutableCopyOf("ext_map_int32_int32", builder.ext_map_int32_int32);
    this.ext_map_string_string = Internal.INSTANCE.immutableCopyOf("ext_map_string_string", builder.ext_map_string_string);
    this.ext_map_string_message = Internal.INSTANCE.immutableCopyOf("ext_map_string_message", builder.ext_map_string_message);
    this.ext_map_string_enum = Internal.INSTANCE.immutableCopyOf("ext_map_string_enum", builder.ext_map_string_enum);
  }
  ...
  public Builder newBuilder() {
    ...
    builder.rep_uint32 = Internal.INSTANCE.copyOf("rep_uint32", rep_uint32);
    builder.rep_sint32 = Internal.INSTANCE.copyOf("rep_sint32", rep_sint32);
    builder.rep_fixed32 = Internal.INSTANCE.copyOf("rep_fixed32", rep_fixed32);
    builder.rep_sfixed32 = Internal.INSTANCE.copyOf("rep_sfixed32", rep_sfixed32);
    builder.rep_int64 = Internal.INSTANCE.copyOf("rep_int64", rep_int64);
    builder.rep_uint64 = Internal.INSTANCE.copyOf("rep_uint64", rep_uint64);
    builder.rep_sint64 = Internal.INSTANCE.copyOf("rep_sint64", rep_sint64);
    builder.rep_fixed64 = Internal.INSTANCE.copyOf("rep_fixed64", rep_fixed64);
    builder.rep_sfixed64 = Internal.INSTANCE.copyOf("rep_sfixed64", rep_sfixed64);
    builder.rep_bool = Internal.INSTANCE.copyOf("rep_bool", rep_bool);
    builder.rep_float = Internal.INSTANCE.copyOf("rep_float", rep_float);
    builder.rep_double = Internal.INSTANCE.copyOf("rep_double", rep_double);
    builder.rep_string = Internal.INSTANCE.copyOf("rep_string", rep_string);
    builder.rep_bytes = Internal.INSTANCE.copyOf("rep_bytes", rep_bytes);
    builder.rep_nested_enum = Internal.INSTANCE.copyOf("rep_nested_enum", rep_nested_enum);
    builder.rep_nested_message = Internal.INSTANCE.copyOf("rep_nested_message", rep_nested_message);
    builder.pack_int32 = Internal.INSTANCE.copyOf("pack_int32", pack_int32);
    builder.pack_uint32 = Internal.INSTANCE.copyOf("pack_uint32", pack_uint32);
    builder.pack_sint32 = Internal.INSTANCE.copyOf("pack_sint32", pack_sint32);
    builder.pack_fixed32 = Internal.INSTANCE.copyOf("pack_fixed32", pack_fixed32);
    builder.pack_sfixed32 = Internal.INSTANCE.copyOf("pack_sfixed32", pack_sfixed32);
    builder.pack_int64 = Internal.INSTANCE.copyOf("pack_int64", pack_int64);
    builder.pack_uint64 = Internal.INSTANCE.copyOf("pack_uint64", pack_uint64);
    builder.pack_sint64 = Internal.INSTANCE.copyOf("pack_sint64", pack_sint64);
    builder.pack_fixed64 = Internal.INSTANCE.copyOf("pack_fixed64", pack_fixed64);
    builder.pack_sfixed64 = Internal.INSTANCE.copyOf("pack_sfixed64", pack_sfixed64);
    builder.pack_bool = Internal.INSTANCE.copyOf("pack_bool", pack_bool);
    builder.pack_float = Internal.INSTANCE.copyOf("pack_float", pack_float);
    builder.pack_double = Internal.INSTANCE.copyOf("pack_double", pack_double);
    builder.pack_nested_enum = Internal.INSTANCE.copyOf("pack_nested_enum", pack_nested_enum);
    ...
    builder.map_string_string = Internal.INSTANCE.copyOf("map_string_string", map_string_string);
    builder.map_string_message = Internal.INSTANCE.copyOf("map_string_message", map_string_message);
    builder.map_string_enum = Internal.INSTANCE.copyOf("map_string_enum", map_string_enum);
    ...
    builder.ext_rep_int32 = Internal.INSTANCE.copyOf("ext_rep_int32", ext_rep_int32);
    builder.ext_rep_uint32 = Internal.INSTANCE.copyOf("ext_rep_uint32", ext_rep_uint32);
    builder.ext_rep_sint32 = Internal.INSTANCE.copyOf("ext_rep_sint32", ext_rep_sint32);
    builder.ext_rep_fixed32 = Internal.INSTANCE.copyOf("ext_rep_fixed32", ext_rep_fixed32);
    builder.ext_rep_sfixed32 = Internal.INSTANCE.copyOf("ext_rep_sfixed32", ext_rep_sfixed32);
    builder.ext_rep_int64 = Internal.INSTANCE.copyOf("ext_rep_int64", ext_rep_int64);
    builder.ext_rep_uint64 = Internal.INSTANCE.copyOf("ext_rep_uint64", ext_rep_uint64);
    builder.ext_rep_sint64 = Internal.INSTANCE.copyOf("ext_rep_sint64", ext_rep_sint64);
    builder.ext_rep_fixed64 = Internal.INSTANCE.copyOf("ext_rep_fixed64", ext_rep_fixed64);
    builder.ext_rep_sfixed64 = Internal.INSTANCE.copyOf("ext_rep_sfixed64", ext_rep_sfixed64);
    builder.ext_rep_bool = Internal.INSTANCE.copyOf("ext_rep_bool", ext_rep_bool);
    builder.ext_rep_float = Internal.INSTANCE.copyOf("ext_rep_float", ext_rep_float);
    builder.ext_rep_double = Internal.INSTANCE.copyOf("ext_rep_double", ext_rep_double);
    builder.ext_rep_string = Internal.INSTANCE.copyOf("ext_rep_string", ext_rep_string);
    builder.ext_rep_bytes = Internal.INSTANCE.copyOf("ext_rep_bytes", ext_rep_bytes);
    builder.ext_rep_nested_enum = Internal.INSTANCE.copyOf("ext_rep_nested_enum", ext_rep_nested_enum);
    builder.ext_rep_nested_message = Internal.INSTANCE.copyOf("ext_rep_nested_message", ext_rep_nested_message);
    builder.ext_pack_int32 = Internal.INSTANCE.copyOf("ext_pack_int32", ext_pack_int32);
    builder.ext_pack_uint32 = Internal.INSTANCE.copyOf("ext_pack_uint32", ext_pack_uint32);
    builder.ext_pack_sint32 = Internal.INSTANCE.copyOf("ext_pack_sint32", ext_pack_sint32);
    builder.ext_pack_fixed32 = Internal.INSTANCE.copyOf("ext_pack_fixed32", ext_pack_fixed32);
    builder.ext_pack_sfixed32 = Internal.INSTANCE.copyOf("ext_pack_sfixed32", ext_pack_sfixed32);
    builder.ext_pack_int64 = Internal.INSTANCE.copyOf("ext_pack_int64", ext_pack_int64);
    builder.ext_pack_uint64 = Internal.INSTANCE.copyOf("ext_pack_uint64", ext_pack_uint64);
    builder.ext_pack_sint64 = Internal.INSTANCE.copyOf("ext_pack_sint64", ext_pack_sint64);
    builder.ext_pack_fixed64 = Internal.INSTANCE.copyOf("ext_pack_fixed64", ext_pack_fixed64);
    builder.ext_pack_sfixed64 = Internal.INSTANCE.copyOf("ext_pack_sfixed64", ext_pack_sfixed64);
    builder.ext_pack_bool = Internal.INSTANCE.copyOf("ext_pack_bool", ext_pack_bool);
    builder.ext_pack_float = Internal.INSTANCE.copyOf("ext_pack_float", ext_pack_float);
    builder.ext_pack_double = Internal.INSTANCE.copyOf("ext_pack_double", ext_pack_double);
    builder.ext_pack_nested_enum = Internal.INSTANCE.copyOf("ext_pack_nested_enum", ext_pack_nested_enum);
    builder.ext_map_int32_int32 = Internal.INSTANCE.copyOf("ext_map_int32_int32", ext_map_int32_int32);
    builder.ext_map_string_string = Internal.INSTANCE.copyOf("ext_map_string_string", ext_map_string_string);
    builder.ext_map_string_message = Internal.INSTANCE.copyOf("ext_map_string_message", ext_map_string_message);
    builder.ext_map_string_enum = Internal.INSTANCE.copyOf("ext_map_string_enum", ext_map_string_enum);
  ...
  public boolean equals(Object other) {
    ...
    return unknownFields().equals(o.unknownFields())
        ...
        && Internal.INSTANCE.equals(opt_uint32, o.opt_uint32)
        && Internal.INSTANCE.equals(opt_sint32, o.opt_sint32)
        && Internal.INSTANCE.equals(opt_fixed32, o.opt_fixed32)
        && Internal.INSTANCE.equals(opt_sfixed32, o.opt_sfixed32)
        && Internal.INSTANCE.equals(opt_int64, o.opt_int64)
        && Internal.INSTANCE.equals(opt_uint64, o.opt_uint64)
        && Internal.INSTANCE.equals(opt_sint64, o.opt_sint64)
        && Internal.INSTANCE.equals(opt_fixed64, o.opt_fixed64)
        && Internal.INSTANCE.equals(opt_sfixed64, o.opt_sfixed64)
        && Internal.INSTANCE.equals(opt_bool, o.opt_bool)
        && Internal.INSTANCE.equals(opt_float, o.opt_float)
        && Internal.INSTANCE.equals(opt_double, o.opt_double)
        && Internal.INSTANCE.equals(opt_string, o.opt_string)
        && Internal.INSTANCE.equals(opt_bytes, o.opt_bytes)
        && Internal.INSTANCE.equals(opt_nested_enum, o.opt_nested_enum)
        && Internal.INSTANCE.equals(opt_nested_message, o.opt_nested_message)
        ...
        && Internal.INSTANCE.equals(default_int32, o.default_int32)
        && Internal.INSTANCE.equals(default_uint32, o.default_uint32)
        && Internal.INSTANCE.equals(default_sint32, o.default_sint32)
        && Internal.INSTANCE.equals(default_fixed32, o.default_fixed32)
        && Internal.INSTANCE.equals(default_sfixed32, o.default_sfixed32)
        && Internal.INSTANCE.equals(default_int64, o.default_int64)
        && Internal.INSTANCE.equals(default_uint64, o.default_uint64)
        && Internal.INSTANCE.equals(default_sint64, o.default_sint64)
        && Internal.INSTANCE.equals(default_fixed64, o.default_fixed64)
        && Internal.INSTANCE.equals(default_sfixed64, o.default_sfixed64)
        && Internal.INSTANCE.equals(default_bool, o.default_bool)
        && Internal.INSTANCE.equals(default_float, o.default_float)
        && Internal.INSTANCE.equals(default_double, o.default_double)
        && Internal.INSTANCE.equals(default_string, o.default_string)
        && Internal.INSTANCE.equals(default_bytes, o.default_bytes)
        && Internal.INSTANCE.equals(default_nested_enum, o.default_nested_enum)
        ...
        && Internal.INSTANCE.equals(ext_opt_int32, o.ext_opt_int32)
        && Internal.INSTANCE.equals(ext_opt_uint32, o.ext_opt_uint32)
        && Internal.INSTANCE.equals(ext_opt_sint32, o.ext_opt_sint32)
        && Internal.INSTANCE.equals(ext_opt_fixed32, o.ext_opt_fixed32)
        && Internal.INSTANCE.equals(ext_opt_sfixed32, o.ext_opt_sfixed32)
        && Internal.INSTANCE.equals(ext_opt_int64, o.ext_opt_int64)
        && Internal.INSTANCE.equals(ext_opt_uint64, o.ext_opt_uint64)
        && Internal.INSTANCE.equals(ext_opt_sint64, o.ext_opt_sint64)
        && Internal.INSTANCE.equals(ext_opt_fixed64, o.ext_opt_fixed64)
        && Internal.INSTANCE.equals(ext_opt_sfixed64, o.ext_opt_sfixed64)
        && Internal.INSTANCE.equals(ext_opt_bool, o.ext_opt_bool)
        && Internal.INSTANCE.equals(ext_opt_float, o.ext_opt_float)
        && Internal.INSTANCE.equals(ext_opt_double, o.ext_opt_double)
        && Internal.INSTANCE.equals(ext_opt_string, o.ext_opt_string)
        && Internal.INSTANCE.equals(ext_opt_bytes, o.ext_opt_bytes)
        && Internal.INSTANCE.equals(ext_opt_nested_enum, o.ext_opt_nested_enum)
        && Internal.INSTANCE.equals(ext_opt_nested_message, o.ext_opt_nested_message)
  ...
  public static final class Builder extends Message.Builder<AllTypes, Builder> {
    ...
    public Builder() {
      ...
      rep_uint32 = Internal.INSTANCE.newMutableList();
      rep_sint32 = Internal.INSTANCE.newMutableList();
      rep_fixed32 = Internal.INSTANCE.newMutableList();
      rep_sfixed32 = Internal.INSTANCE.newMutableList();
      rep_int64 = Internal.INSTANCE.newMutableList();
      rep_uint64 = Internal.INSTANCE.newMutableList();
      rep_sint64 = Internal.INSTANCE.newMutableList();
      rep_fixed64 = Internal.INSTANCE.newMutableList();
      rep_sfixed64 = Internal.INSTANCE.newMutableList();
      rep_bool = Internal.INSTANCE.newMutableList();
      rep_float = Internal.INSTANCE.newMutableList();
      rep_double = Internal.INSTANCE.newMutableList();
      rep_string = Internal.INSTANCE.newMutableList();
      rep_bytes = Internal.INSTANCE.newMutableList();
      rep_nested_enum = Internal.INSTANCE.newMutableList();
      rep_nested_message = Internal.INSTANCE.newMutableList();
      pack_int32 = Internal.INSTANCE.newMutableList();
      pack_uint32 = Internal.INSTANCE.newMutableList();
      pack_sint32 = Internal.INSTANCE.newMutableList();
      pack_fixed32 = Internal.INSTANCE.newMutableList();
      pack_sfixed32 = Internal.INSTANCE.newMutableList();
      pack_int64 = Internal.INSTANCE.newMutableList();
      pack_uint64 = Internal.INSTANCE.newMutableList();
      pack_sint64 = Internal.INSTANCE.newMutableList();
      pack_fixed64 = Internal.INSTANCE.newMutableList();
      pack_sfixed64 = Internal.INSTANCE.newMutableList();
      pack_bool = Internal.INSTANCE.newMutableList();
      pack_float = Internal.INSTANCE.newMutableList();
      pack_double = Internal.INSTANCE.newMutableList();
      pack_nested_enum = Internal.INSTANCE.newMutableList();
      map_int32_int32 = Internal.INSTANCE.newMutableMap();
      map_string_string = Internal.INSTANCE.newMutableMap();
      map_string_message = Internal.INSTANCE.newMutableMap();
      map_string_enum = Internal.INSTANCE.newMutableMap();
      ext_rep_int32 = Internal.INSTANCE.newMutableList();
      ext_rep_uint32 = Internal.INSTANCE.newMutableList();
      ext_rep_sint32 = Internal.INSTANCE.newMutableList();
      ext_rep_fixed32 = Internal.INSTANCE.newMutableList();
      ext_rep_sfixed32 = Internal.INSTANCE.newMutableList();
      ext_rep_int64 = Internal.INSTANCE.newMutableList();
      ext_rep_uint64 = Internal.INSTANCE.newMutableList();
      ext_rep_sint64 = Internal.INSTANCE.newMutableList();
      ext_rep_fixed64 = Internal.INSTANCE.newMutableList();
      ext_rep_sfixed64 = Internal.INSTANCE.newMutableList();
      ext_rep_bool = Internal.INSTANCE.newMutableList();
      ext_rep_float = Internal.INSTANCE.newMutableList();
      ext_rep_double = Internal.INSTANCE.newMutableList();
      ext_rep_string = Internal.INSTANCE.newMutableList();
      ext_rep_bytes = Internal.INSTANCE.newMutableList();
      ext_rep_nested_enum = Internal.INSTANCE.newMutableList();
      ext_rep_nested_message = Internal.INSTANCE.newMutableList();
      ext_pack_int32 = Internal.INSTANCE.newMutableList();
      ext_pack_uint32 = Internal.INSTANCE.newMutableList();
      ext_pack_sint32 = Internal.INSTANCE.newMutableList();
      ext_pack_fixed32 = Internal.INSTANCE.newMutableList();
      ext_pack_sfixed32 = Internal.INSTANCE.newMutableList();
      ext_pack_int64 = Internal.INSTANCE.newMutableList();
      ext_pack_uint64 = Internal.INSTANCE.newMutableList();
      ext_pack_sint64 = Internal.INSTANCE.newMutableList();
      ext_pack_fixed64 = Internal.INSTANCE.newMutableList();
      ext_pack_sfixed64 = Internal.INSTANCE.newMutableList();
      ext_pack_bool = Internal.INSTANCE.newMutableList();
      ext_pack_float = Internal.INSTANCE.newMutableList();
      ext_pack_double = Internal.INSTANCE.newMutableList();
      ext_pack_nested_enum = Internal.INSTANCE.newMutableList();
      ext_map_int32_int32 = Internal.INSTANCE.newMutableMap();
      ext_map_string_string = Internal.INSTANCE.newMutableMap();
      ext_map_string_message = Internal.INSTANCE.newMutableMap();
      ext_map_string_enum = Internal.INSTANCE.newMutableMap();
    }
    ...
    public Builder ext_map_string_message(Map<String, NestedMessage> ext_map_string_message) {
      Internal.INSTANCE.checkElementsNotNull(ext_map_string_message);
    ...
    public Builder ext_map_string_enum(Map<String, NestedEnum> ext_map_string_enum) {
      Internal.INSTANCE.checkElementsNotNull(ext_map_string_enum);
    ...
    public AllTypes build() {
      if (req_int32 == null
        ...
        throw Internal.INSTANCE.missingRequiredFields(req_int32, "req_int32",
  ...
  public static final class NestedMessage extends Message<NestedMessage, NestedMessage.Builder> {
    ...
    private static final class ProtoAdapter_NestedMessage extends ProtoAdapter<NestedMessage> {
      ...
      public int encodedSize(NestedMessage value) {
        return ProtoAdapter.Companion.getINT32().encodedSizeWithTag(1, value.a)
            + value.unknownFields().size();
      }

      @Override
      public void encode(ProtoWriter writer, NestedMessage value) throws IOException {
        ProtoAdapter.Companion.getINT32().encodeWithTag(writer, 1, value.a);
      ...
      public NestedMessage decode(ProtoReader reader) throws IOException {
        ...
        for (int tag; (tag = reader.nextTag()) != -1;) {
          switch (tag) {
            case 1: builder.a(ProtoAdapter.Companion.getINT32().decode(reader)); break;
            default: {
  ...
  private static final class ProtoAdapter_AllTypes extends ProtoAdapter<AllTypes> {
    ...
    private final ProtoAdapter<Map<String, String>> map_string_string = ProtoAdapter.Companion.newMapAdapter(ProtoAdapter.Companion.getSTRING(), ProtoAdapter.Companion.getSTRING());

    private final ProtoAdapter<Map<String, NestedMessage>> map_string_message = ProtoAdapter.Companion.newMapAdapter(ProtoAdapter.Companion.getSTRING(), NestedMessage.ADAPTER);

    private final ProtoAdapter<Map<String, NestedEnum>> map_string_enum = ProtoAdapter.Companion.newMapAdapter(ProtoAdapter.Companion.getSTRING(), NestedEnum.ADAPTER);

    private final ProtoAdapter<Map<Integer, Integer>> ext_map_int32_int32 = ProtoAdapter.Companion.newMapAdapter(ProtoAdapter.Companion.getINT32(), ProtoAdapter.Companion.getINT32());

    private final ProtoAdapter<Map<String, String>> ext_map_string_string = ProtoAdapter.Companion.newMapAdapter(ProtoAdapter.Companion.getSTRING(), ProtoAdapter.Companion.getSTRING());

    private final ProtoAdapter<Map<String, NestedMessage>> ext_map_string_message = ProtoAdapter.Companion.newMapAdapter(ProtoAdapter.Companion.getSTRING(), NestedMessage.ADAPTER);

    private final ProtoAdapter<Map<String, NestedEnum>> ext_map_string_enum = ProtoAdapter.Companion.newMapAdapter(ProtoAdapter.Companion.getSTRING(), NestedEnum.ADAPTER);
    ...
    public int encodedSize(AllTypes value) {
      return ProtoAdapter.Companion.getINT32().encodedSizeWithTag(1, value.opt_int32)
          + ProtoAdapter.Companion.getUINT32().encodedSizeWithTag(2, value.opt_uint32)
          + ProtoAdapter.Companion.getSINT32().encodedSizeWithTag(3, value.opt_sint32)
          + ProtoAdapter.Companion.getFIXED32().encodedSizeWithTag(4, value.opt_fixed32)
          + ProtoAdapter.Companion.getSFIXED32().encodedSizeWithTag(5, value.opt_sfixed32)
          + ProtoAdapter.Companion.getINT64().encodedSizeWithTag(6, value.opt_int64)
          + ProtoAdapter.Companion.getUINT64().encodedSizeWithTag(7, value.opt_uint64)
          + ProtoAdapter.Companion.getSINT64().encodedSizeWithTag(8, value.opt_sint64)
          + ProtoAdapter.Companion.getFIXED64().encodedSizeWithTag(9, value.opt_fixed64)
          + ProtoAdapter.Companion.getSFIXED64().encodedSizeWithTag(10, value.opt_sfixed64)
          + ProtoAdapter.Companion.getBOOL().encodedSizeWithTag(11, value.opt_bool)
          + ProtoAdapter.Companion.getFLOAT().encodedSizeWithTag(12, value.opt_float)
          + ProtoAdapter.Companion.getDOUBLE().encodedSizeWithTag(13, value.opt_double)
          + ProtoAdapter.Companion.getSTRING().encodedSizeWithTag(14, value.opt_string)
          + ProtoAdapter.Companion.getBYTES().encodedSizeWithTag(15, value.opt_bytes)
          ...
          + ProtoAdapter.Companion.getINT32().encodedSizeWithTag(101, value.req_int32)
          + ProtoAdapter.Companion.getUINT32().encodedSizeWithTag(102, value.req_uint32)
          + ProtoAdapter.Companion.getSINT32().encodedSizeWithTag(103, value.req_sint32)
          + ProtoAdapter.Companion.getFIXED32().encodedSizeWithTag(104, value.req_fixed32)
          + ProtoAdapter.Companion.getSFIXED32().encodedSizeWithTag(105, value.req_sfixed32)
          + ProtoAdapter.Companion.getINT64().encodedSizeWithTag(106, value.req_int64)
          + ProtoAdapter.Companion.getUINT64().encodedSizeWithTag(107, value.req_uint64)
          + ProtoAdapter.Companion.getSINT64().encodedSizeWithTag(108, value.req_sint64)
          + ProtoAdapter.Companion.getFIXED64().encodedSizeWithTag(109, value.req_fixed64)
          + ProtoAdapter.Companion.getSFIXED64().encodedSizeWithTag(110, value.req_sfixed64)
          + ProtoAdapter.Companion.getBOOL().encodedSizeWithTag(111, value.req_bool)
          + ProtoAdapter.Companion.getFLOAT().encodedSizeWithTag(112, value.req_float)
          + ProtoAdapter.Companion.getDOUBLE().encodedSizeWithTag(113, value.req_double)
          + ProtoAdapter.Companion.getSTRING().encodedSizeWithTag(114, value.req_string)
          + ProtoAdapter.Companion.getBYTES().encodedSizeWithTag(115, value.req_bytes)
          ...
          + ProtoAdapter.Companion.getINT32().asRepeated().encodedSizeWithTag(201, value.rep_int32)
          + ProtoAdapter.Companion.getUINT32().asRepeated().encodedSizeWithTag(202, value.rep_uint32)
          + ProtoAdapter.Companion.getSINT32().asRepeated().encodedSizeWithTag(203, value.rep_sint32)
          + ProtoAdapter.Companion.getFIXED32().asRepeated().encodedSizeWithTag(204, value.rep_fixed32)
          + ProtoAdapter.Companion.getSFIXED32().asRepeated().encodedSizeWithTag(205, value.rep_sfixed32)
          + ProtoAdapter.Companion.getINT64().asRepeated().encodedSizeWithTag(206, value.rep_int64)
          + ProtoAdapter.Companion.getUINT64().asRepeated().encodedSizeWithTag(207, value.rep_uint64)
          + ProtoAdapter.Companion.getSINT64().asRepeated().encodedSizeWithTag(208, value.rep_sint64)
          + ProtoAdapter.Companion.getFIXED64().asRepeated().encodedSizeWithTag(209, value.rep_fixed64)
          + ProtoAdapter.Companion.getSFIXED64().asRepeated().encodedSizeWithTag(210, value.rep_sfixed64)
          + ProtoAdapter.Companion.getBOOL().asRepeated().encodedSizeWithTag(211, value.rep_bool)
          + ProtoAdapter.Companion.getFLOAT().asRepeated().encodedSizeWithTag(212, value.rep_float)
          + ProtoAdapter.Companion.getDOUBLE().asRepeated().encodedSizeWithTag(213, value.rep_double)
          + ProtoAdapter.Companion.getSTRING().asRepeated().encodedSizeWithTag(214, value.rep_string)
          + ProtoAdapter.Companion.getBYTES().asRepeated().encodedSizeWithTag(215, value.rep_bytes)
          ...
          + ProtoAdapter.Companion.getUINT32().asPacked().encodedSizeWithTag(302, value.pack_uint32)
          + ProtoAdapter.Companion.getSINT32().asPacked().encodedSizeWithTag(303, value.pack_sint32)
          + ProtoAdapter.Companion.getFIXED32().asPacked().encodedSizeWithTag(304, value.pack_fixed32)
          + ProtoAdapter.Companion.getSFIXED32().asPacked().encodedSizeWithTag(305, value.pack_sfixed32)
          + ProtoAdapter.Companion.getINT64().asPacked().encodedSizeWithTag(306, value.pack_int64)
          + ProtoAdapter.Companion.getUINT64().asPacked().encodedSizeWithTag(307, value.pack_uint64)
          + ProtoAdapter.Companion.getSINT64().asPacked().encodedSizeWithTag(308, value.pack_sint64)
          + ProtoAdapter.Companion.getFIXED64().asPacked().encodedSizeWithTag(309, value.pack_fixed64)
          + ProtoAdapter.Companion.getSFIXED64().asPacked().encodedSizeWithTag(310, value.pack_sfixed64)
          + ProtoAdapter.Companion.getBOOL().asPacked().encodedSizeWithTag(311, value.pack_bool)
          + ProtoAdapter.Companion.getFLOAT().asPacked().encodedSizeWithTag(312, value.pack_float)
          + ProtoAdapter.Companion.getDOUBLE().asPacked().encodedSizeWithTag(313, value.pack_double)
          + NestedEnum.ADAPTER.asPacked().encodedSizeWithTag(316, value.pack_nested_enum)
          + ProtoAdapter.Companion.getINT32().encodedSizeWithTag(401, value.default_int32)
          + ProtoAdapter.Companion.getUINT32().encodedSizeWithTag(402, value.default_uint32)
          + ProtoAdapter.Companion.getSINT32().encodedSizeWithTag(403, value.default_sint32)
          + ProtoAdapter.Companion.getFIXED32().encodedSizeWithTag(404, value.default_fixed32)
          + ProtoAdapter.Companion.getSFIXED32().encodedSizeWithTag(405, value.default_sfixed32)
          + ProtoAdapter.Companion.getINT64().encodedSizeWithTag(406, value.default_int64)
          + ProtoAdapter.Companion.getUINT64().encodedSizeWithTag(407, value.default_uint64)
          + ProtoAdapter.Companion.getSINT64().encodedSizeWithTag(408, value.default_sint64)
          + ProtoAdapter.Companion.getFIXED64().encodedSizeWithTag(409, value.default_fixed64)
          + ProtoAdapter.Companion.getSFIXED64().encodedSizeWithTag(410, value.default_sfixed64)
          + ProtoAdapter.Companion.getBOOL().encodedSizeWithTag(411, value.default_bool)
          + ProtoAdapter.Companion.getFLOAT().encodedSizeWithTag(412, value.default_float)
          + ProtoAdapter.Companion.getDOUBLE().encodedSizeWithTag(413, value.default_double)
          + ProtoAdapter.Companion.getSTRING().encodedSizeWithTag(414, value.default_string)
          + ProtoAdapter.Companion.getBYTES().encodedSizeWithTag(415, value.default_bytes)
          ...
          + ProtoAdapter.Companion.getINT32().encodedSizeWithTag(1001, value.ext_opt_int32)
          + ProtoAdapter.Companion.getUINT32().encodedSizeWithTag(1002, value.ext_opt_uint32)
          + ProtoAdapter.Companion.getSINT32().encodedSizeWithTag(1003, value.ext_opt_sint32)
          + ProtoAdapter.Companion.getFIXED32().encodedSizeWithTag(1004, value.ext_opt_fixed32)
          + ProtoAdapter.Companion.getSFIXED32().encodedSizeWithTag(1005, value.ext_opt_sfixed32)
          + ProtoAdapter.Companion.getINT64().encodedSizeWithTag(1006, value.ext_opt_int64)
          + ProtoAdapter.Companion.getUINT64().encodedSizeWithTag(1007, value.ext_opt_uint64)
          + ProtoAdapter.Companion.getSINT64().encodedSizeWithTag(1008, value.ext_opt_sint64)
          + ProtoAdapter.Companion.getFIXED64().encodedSizeWithTag(1009, value.ext_opt_fixed64)
          + ProtoAdapter.Companion.getSFIXED64().encodedSizeWithTag(1010, value.ext_opt_sfixed64)
          + ProtoAdapter.Companion.getBOOL().encodedSizeWithTag(1011, value.ext_opt_bool)
          + ProtoAdapter.Companion.getFLOAT().encodedSizeWithTag(1012, value.ext_opt_float)
          + ProtoAdapter.Companion.getDOUBLE().encodedSizeWithTag(1013, value.ext_opt_double)
          + ProtoAdapter.Companion.getSTRING().encodedSizeWithTag(1014, value.ext_opt_string)
          + ProtoAdapter.Companion.getBYTES().encodedSizeWithTag(1015, value.ext_opt_bytes)
          ...
          + ProtoAdapter.Companion.getINT32().asRepeated().encodedSizeWithTag(1101, value.ext_rep_int32)
          + ProtoAdapter.Companion.getUINT32().asRepeated().encodedSizeWithTag(1102, value.ext_rep_uint32)
          + ProtoAdapter.Companion.getSINT32().asRepeated().encodedSizeWithTag(1103, value.ext_rep_sint32)
          + ProtoAdapter.Companion.getFIXED32().asRepeated().encodedSizeWithTag(1104, value.ext_rep_fixed32)
          + ProtoAdapter.Companion.getSFIXED32().asRepeated().encodedSizeWithTag(1105, value.ext_rep_sfixed32)
          + ProtoAdapter.Companion.getINT64().asRepeated().encodedSizeWithTag(1106, value.ext_rep_int64)
          + ProtoAdapter.Companion.getUINT64().asRepeated().encodedSizeWithTag(1107, value.ext_rep_uint64)
          + ProtoAdapter.Companion.getSINT64().asRepeated().encodedSizeWithTag(1108, value.ext_rep_sint64)
          + ProtoAdapter.Companion.getFIXED64().asRepeated().encodedSizeWithTag(1109, value.ext_rep_fixed64)
          + ProtoAdapter.Companion.getSFIXED64().asRepeated().encodedSizeWithTag(1110, value.ext_rep_sfixed64)
          + ProtoAdapter.Companion.getBOOL().asRepeated().encodedSizeWithTag(1111, value.ext_rep_bool)
          + ProtoAdapter.Companion.getFLOAT().asRepeated().encodedSizeWithTag(1112, value.ext_rep_float)
          + ProtoAdapter.Companion.getDOUBLE().asRepeated().encodedSizeWithTag(1113, value.ext_rep_double)
          + ProtoAdapter.Companion.getSTRING().asRepeated().encodedSizeWithTag(1114, value.ext_rep_string)
          + ProtoAdapter.Companion.getBYTES().asRepeated().encodedSizeWithTag(1115, value.ext_rep_bytes)
          ...
          + ProtoAdapter.Companion.getINT32().asPacked().encodedSizeWithTag(1201, value.ext_pack_int32)
          + ProtoAdapter.Companion.getUINT32().asPacked().encodedSizeWithTag(1202, value.ext_pack_uint32)
          + ProtoAdapter.Companion.getSINT32().asPacked().encodedSizeWithTag(1203, value.ext_pack_sint32)
          + ProtoAdapter.Companion.getFIXED32().asPacked().encodedSizeWithTag(1204, value.ext_pack_fixed32)
          + ProtoAdapter.Companion.getSFIXED32().asPacked().encodedSizeWithTag(1205, value.ext_pack_sfixed32)
          + ProtoAdapter.Companion.getINT64().asPacked().encodedSizeWithTag(1206, value.ext_pack_int64)
          + ProtoAdapter.Companion.getUINT64().asPacked().encodedSizeWithTag(1207, value.ext_pack_uint64)
          + ProtoAdapter.Companion.getSINT64().asPacked().encodedSizeWithTag(1208, value.ext_pack_sint64)
          + ProtoAdapter.Companion.getFIXED64().asPacked().encodedSizeWithTag(1209, value.ext_pack_fixed64)
          + ProtoAdapter.Companion.getSFIXED64().asPacked().encodedSizeWithTag(1210, value.ext_pack_sfixed64)
          + ProtoAdapter.Companion.getBOOL().asPacked().encodedSizeWithTag(1211, value.ext_pack_bool)
          + ProtoAdapter.Companion.getFLOAT().asPacked().encodedSizeWithTag(1212, value.ext_pack_float)
          + ProtoAdapter.Companion.getDOUBLE().asPacked().encodedSizeWithTag(1213, value.ext_pack_double)
    ...
    public void encode(ProtoWriter writer, AllTypes value) throws IOException {
      ProtoAdapter.Companion.getINT32().encodeWithTag(writer, 1, value.opt_int32);
      ProtoAdapter.Companion.getUINT32().encodeWithTag(writer, 2, value.opt_uint32);
      ProtoAdapter.Companion.getSINT32().encodeWithTag(writer, 3, value.opt_sint32);
      ProtoAdapter.Companion.getFIXED32().encodeWithTag(writer, 4, value.opt_fixed32);
      ProtoAdapter.Companion.getSFIXED32().encodeWithTag(writer, 5, value.opt_sfixed32);
      ProtoAdapter.Companion.getINT64().encodeWithTag(writer, 6, value.opt_int64);
      ProtoAdapter.Companion.getUINT64().encodeWithTag(writer, 7, value.opt_uint64);
      ProtoAdapter.Companion.getSINT64().encodeWithTag(writer, 8, value.opt_sint64);
      ProtoAdapter.Companion.getFIXED64().encodeWithTag(writer, 9, value.opt_fixed64);
      ProtoAdapter.Companion.getSFIXED64().encodeWithTag(writer, 10, value.opt_sfixed64);
      ProtoAdapter.Companion.getBOOL().encodeWithTag(writer, 11, value.opt_bool);
      ProtoAdapter.Companion.getFLOAT().encodeWithTag(writer, 12, value.opt_float);
      ProtoAdapter.Companion.getDOUBLE().encodeWithTag(writer, 13, value.opt_double);
      ProtoAdapter.Companion.getSTRING().encodeWithTag(writer, 14, value.opt_string);
      ProtoAdapter.Companion.getBYTES().encodeWithTag(writer, 15, value.opt_bytes);
      ...
      ProtoAdapter.Companion.getINT32().encodeWithTag(writer, 101, value.req_int32);
      ProtoAdapter.Companion.getUINT32().encodeWithTag(writer, 102, value.req_uint32);
      ProtoAdapter.Companion.getSINT32().encodeWithTag(writer, 103, value.req_sint32);
      ProtoAdapter.Companion.getFIXED32().encodeWithTag(writer, 104, value.req_fixed32);
      ProtoAdapter.Companion.getSFIXED32().encodeWithTag(writer, 105, value.req_sfixed32);
      ProtoAdapter.Companion.getINT64().encodeWithTag(writer, 106, value.req_int64);
      ProtoAdapter.Companion.getUINT64().encodeWithTag(writer, 107, value.req_uint64);
      ProtoAdapter.Companion.getSINT64().encodeWithTag(writer, 108, value.req_sint64);
      ProtoAdapter.Companion.getFIXED64().encodeWithTag(writer, 109, value.req_fixed64);
      ProtoAdapter.Companion.getSFIXED64().encodeWithTag(writer, 110, value.req_sfixed64);
      ProtoAdapter.Companion.getBOOL().encodeWithTag(writer, 111, value.req_bool);
      ProtoAdapter.Companion.getFLOAT().encodeWithTag(writer, 112, value.req_float);
      ProtoAdapter.Companion.getDOUBLE().encodeWithTag(writer, 113, value.req_double);
      ProtoAdapter.Companion.getSTRING().encodeWithTag(writer, 114, value.req_string);
      ProtoAdapter.Companion.getBYTES().encodeWithTag(writer, 115, value.req_bytes);
      ...
      ProtoAdapter.Companion.getUINT32().asRepeated().encodeWithTag(writer, 202, value.rep_uint32);
      ProtoAdapter.Companion.getSINT32().asRepeated().encodeWithTag(writer, 203, value.rep_sint32);
      ProtoAdapter.Companion.getFIXED32().asRepeated().encodeWithTag(writer, 204, value.rep_fixed32);
      ProtoAdapter.Companion.getSFIXED32().asRepeated().encodeWithTag(writer, 205, value.rep_sfixed32);
      ProtoAdapter.Companion.getINT64().asRepeated().encodeWithTag(writer, 206, value.rep_int64);
      ProtoAdapter.Companion.getUINT64().asRepeated().encodeWithTag(writer, 207, value.rep_uint64);
      ProtoAdapter.Companion.getSINT64().asRepeated().encodeWithTag(writer, 208, value.rep_sint64);
      ProtoAdapter.Companion.getFIXED64().asRepeated().encodeWithTag(writer, 209, value.rep_fixed64);
      ProtoAdapter.Companion.getSFIXED64().asRepeated().encodeWithTag(writer, 210, value.rep_sfixed64);
      ProtoAdapter.Companion.getBOOL().asRepeated().encodeWithTag(writer, 211, value.rep_bool);
      ProtoAdapter.Companion.getFLOAT().asRepeated().encodeWithTag(writer, 212, value.rep_float);
      ProtoAdapter.Companion.getDOUBLE().asRepeated().encodeWithTag(writer, 213, value.rep_double);
      ProtoAdapter.Companion.getSTRING().asRepeated().encodeWithTag(writer, 214, value.rep_string);
      ProtoAdapter.Companion.getBYTES().asRepeated().encodeWithTag(writer, 215, value.rep_bytes);
      ...
      ProtoAdapter.Companion.getUINT32().asPacked().encodeWithTag(writer, 302, value.pack_uint32);
      ProtoAdapter.Companion.getSINT32().asPacked().encodeWithTag(writer, 303, value.pack_sint32);
      ProtoAdapter.Companion.getFIXED32().asPacked().encodeWithTag(writer, 304, value.pack_fixed32);
      ProtoAdapter.Companion.getSFIXED32().asPacked().encodeWithTag(writer, 305, value.pack_sfixed32);
      ProtoAdapter.Companion.getINT64().asPacked().encodeWithTag(writer, 306, value.pack_int64);
      ProtoAdapter.Companion.getUINT64().asPacked().encodeWithTag(writer, 307, value.pack_uint64);
      ProtoAdapter.Companion.getSINT64().asPacked().encodeWithTag(writer, 308, value.pack_sint64);
      ProtoAdapter.Companion.getFIXED64().asPacked().encodeWithTag(writer, 309, value.pack_fixed64);
      ProtoAdapter.Companion.getSFIXED64().asPacked().encodeWithTag(writer, 310, value.pack_sfixed64);
      ProtoAdapter.Companion.getBOOL().asPacked().encodeWithTag(writer, 311, value.pack_bool);
      ProtoAdapter.Companion.getFLOAT().asPacked().encodeWithTag(writer, 312, value.pack_float);
      ProtoAdapter.Companion.getDOUBLE().asPacked().encodeWithTag(writer, 313, value.pack_double);
      NestedEnum.ADAPTER.asPacked().encodeWithTag(writer, 316, value.pack_nested_enum);
      ProtoAdapter.Companion.getINT32().encodeWithTag(writer, 401, value.default_int32);
      ProtoAdapter.Companion.getUINT32().encodeWithTag(writer, 402, value.default_uint32);
      ProtoAdapter.Companion.getSINT32().encodeWithTag(writer, 403, value.default_sint32);
      ProtoAdapter.Companion.getFIXED32().encodeWithTag(writer, 404, value.default_fixed32);
      ProtoAdapter.Companion.getSFIXED32().encodeWithTag(writer, 405, value.default_sfixed32);
      ProtoAdapter.Companion.getINT64().encodeWithTag(writer, 406, value.default_int64);
      ProtoAdapter.Companion.getUINT64().encodeWithTag(writer, 407, value.default_uint64);
      ProtoAdapter.Companion.getSINT64().encodeWithTag(writer, 408, value.default_sint64);
      ProtoAdapter.Companion.getFIXED64().encodeWithTag(writer, 409, value.default_fixed64);
      ProtoAdapter.Companion.getSFIXED64().encodeWithTag(writer, 410, value.default_sfixed64);
      ProtoAdapter.Companion.getBOOL().encodeWithTag(writer, 411, value.default_bool);
      ProtoAdapter.Companion.getFLOAT().encodeWithTag(writer, 412, value.default_float);
      ProtoAdapter.Companion.getDOUBLE().encodeWithTag(writer, 413, value.default_double);
      ProtoAdapter.Companion.getSTRING().encodeWithTag(writer, 414, value.default_string);
      ProtoAdapter.Companion.getBYTES().encodeWithTag(writer, 415, value.default_bytes);
      ...
      ProtoAdapter.Companion.getINT32().encodeWithTag(writer, 1001, value.ext_opt_int32);
      ProtoAdapter.Companion.getUINT32().encodeWithTag(writer, 1002, value.ext_opt_uint32);
      ProtoAdapter.Companion.getSINT32().encodeWithTag(writer, 1003, value.ext_opt_sint32);
      ProtoAdapter.Companion.getFIXED32().encodeWithTag(writer, 1004, value.ext_opt_fixed32);
      ProtoAdapter.Companion.getSFIXED32().encodeWithTag(writer, 1005, value.ext_opt_sfixed32);
      ProtoAdapter.Companion.getINT64().encodeWithTag(writer, 1006, value.ext_opt_int64);
      ProtoAdapter.Companion.getUINT64().encodeWithTag(writer, 1007, value.ext_opt_uint64);
      ProtoAdapter.Companion.getSINT64().encodeWithTag(writer, 1008, value.ext_opt_sint64);
      ProtoAdapter.Companion.getFIXED64().encodeWithTag(writer, 1009, value.ext_opt_fixed64);
      ProtoAdapter.Companion.getSFIXED64().encodeWithTag(writer, 1010, value.ext_opt_sfixed64);
      ProtoAdapter.Companion.getBOOL().encodeWithTag(writer, 1011, value.ext_opt_bool);
      ProtoAdapter.Companion.getFLOAT().encodeWithTag(writer, 1012, value.ext_opt_float);
      ProtoAdapter.Companion.getDOUBLE().encodeWithTag(writer, 1013, value.ext_opt_double);
      ProtoAdapter.Companion.getSTRING().encodeWithTag(writer, 1014, value.ext_opt_string);
      ProtoAdapter.Companion.getBYTES().encodeWithTag(writer, 1015, value.ext_opt_bytes);
      ...
      ProtoAdapter.Companion.getINT32().asRepeated().encodeWithTag(writer, 1101, value.ext_rep_int32);
      ProtoAdapter.Companion.getUINT32().asRepeated().encodeWithTag(writer, 1102, value.ext_rep_uint32);
      ProtoAdapter.Companion.getSINT32().asRepeated().encodeWithTag(writer, 1103, value.ext_rep_sint32);
      ProtoAdapter.Companion.getFIXED32().asRepeated().encodeWithTag(writer, 1104, value.ext_rep_fixed32);
      ProtoAdapter.Companion.getSFIXED32().asRepeated().encodeWithTag(writer, 1105, value.ext_rep_sfixed32);
      ProtoAdapter.Companion.getINT64().asRepeated().encodeWithTag(writer, 1106, value.ext_rep_int64);
      ProtoAdapter.Companion.getUINT64().asRepeated().encodeWithTag(writer, 1107, value.ext_rep_uint64);
      ProtoAdapter.Companion.getSINT64().asRepeated().encodeWithTag(writer, 1108, value.ext_rep_sint64);
      ProtoAdapter.Companion.getFIXED64().asRepeated().encodeWithTag(writer, 1109, value.ext_rep_fixed64);
      ProtoAdapter.Companion.getSFIXED64().asRepeated().encodeWithTag(writer, 1110, value.ext_rep_sfixed64);
      ProtoAdapter.Companion.getBOOL().asRepeated().encodeWithTag(writer, 1111, value.ext_rep_bool);
      ProtoAdapter.Companion.getFLOAT().asRepeated().encodeWithTag(writer, 1112, value.ext_rep_float);
      ProtoAdapter.Companion.getDOUBLE().asRepeated().encodeWithTag(writer, 1113, value.ext_rep_double);
      ProtoAdapter.Companion.getSTRING().asRepeated().encodeWithTag(writer, 1114, value.ext_rep_string);
      ProtoAdapter.Companion.getBYTES().asRepeated().encodeWithTag(writer, 1115, value.ext_rep_bytes);
      ...
      ProtoAdapter.Companion.getINT32().asPacked().encodeWithTag(writer, 1201, value.ext_pack_int32);
      ProtoAdapter.Companion.getUINT32().asPacked().encodeWithTag(writer, 1202, value.ext_pack_uint32);
      ProtoAdapter.Companion.getSINT32().asPacked().encodeWithTag(writer, 1203, value.ext_pack_sint32);
      ProtoAdapter.Companion.getFIXED32().asPacked().encodeWithTag(writer, 1204, value.ext_pack_fixed32);
      ProtoAdapter.Companion.getSFIXED32().asPacked().encodeWithTag(writer, 1205, value.ext_pack_sfixed32);
      ProtoAdapter.Companion.getINT64().asPacked().encodeWithTag(writer, 1206, value.ext_pack_int64);
      ProtoAdapter.Companion.getUINT64().asPacked().encodeWithTag(writer, 1207, value.ext_pack_uint64);
      ProtoAdapter.Companion.getSINT64().asPacked().encodeWithTag(writer, 1208, value.ext_pack_sint64);
      ProtoAdapter.Companion.getFIXED64().asPacked().encodeWithTag(writer, 1209, value.ext_pack_fixed64);
      ProtoAdapter.Companion.getSFIXED64().asPacked().encodeWithTag(writer, 1210, value.ext_pack_sfixed64);
      ProtoAdapter.Companion.getBOOL().asPacked().encodeWithTag(writer, 1211, value.ext_pack_bool);
      ProtoAdapter.Companion.getFLOAT().asPacked().encodeWithTag(writer, 1212, value.ext_pack_float);
      ProtoAdapter.Companion.getDOUBLE().asPacked().encodeWithTag(writer, 1213, value.ext_pack_double);
    ...
    public AllTypes decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          case 1: builder.opt_int32(ProtoAdapter.Companion.getINT32().decode(reader)); break;
          case 2: builder.opt_uint32(ProtoAdapter.Companion.getUINT32().decode(reader)); break;
          case 3: builder.opt_sint32(ProtoAdapter.Companion.getSINT32().decode(reader)); break;
          case 4: builder.opt_fixed32(ProtoAdapter.Companion.getFIXED32().decode(reader)); break;
          case 5: builder.opt_sfixed32(ProtoAdapter.Companion.getSFIXED32().decode(reader)); break;
          case 6: builder.opt_int64(ProtoAdapter.Companion.getINT64().decode(reader)); break;
          case 7: builder.opt_uint64(ProtoAdapter.Companion.getUINT64().decode(reader)); break;
          case 8: builder.opt_sint64(ProtoAdapter.Companion.getSINT64().decode(reader)); break;
          case 9: builder.opt_fixed64(ProtoAdapter.Companion.getFIXED64().decode(reader)); break;
          case 10: builder.opt_sfixed64(ProtoAdapter.Companion.getSFIXED64().decode(reader)); break;
          case 11: builder.opt_bool(ProtoAdapter.Companion.getBOOL().decode(reader)); break;
          case 12: builder.opt_float(ProtoAdapter.Companion.getFLOAT().decode(reader)); break;
          case 13: builder.opt_double(ProtoAdapter.Companion.getDOUBLE().decode(reader)); break;
          case 14: builder.opt_string(ProtoAdapter.Companion.getSTRING().decode(reader)); break;
          case 15: builder.opt_bytes(ProtoAdapter.Companion.getBYTES().decode(reader)); break;
          case 16: {
            try {
          ...
          case 101: builder.req_int32(ProtoAdapter.Companion.getINT32().decode(reader)); break;
          case 102: builder.req_uint32(ProtoAdapter.Companion.getUINT32().decode(reader)); break;
          case 103: builder.req_sint32(ProtoAdapter.Companion.getSINT32().decode(reader)); break;
          case 104: builder.req_fixed32(ProtoAdapter.Companion.getFIXED32().decode(reader)); break;
          case 105: builder.req_sfixed32(ProtoAdapter.Companion.getSFIXED32().decode(reader)); break;
          case 106: builder.req_int64(ProtoAdapter.Companion.getINT64().decode(reader)); break;
          case 107: builder.req_uint64(ProtoAdapter.Companion.getUINT64().decode(reader)); break;
          case 108: builder.req_sint64(ProtoAdapter.Companion.getSINT64().decode(reader)); break;
          case 109: builder.req_fixed64(ProtoAdapter.Companion.getFIXED64().decode(reader)); break;
          case 110: builder.req_sfixed64(ProtoAdapter.Companion.getSFIXED64().decode(reader)); break;
          case 111: builder.req_bool(ProtoAdapter.Companion.getBOOL().decode(reader)); break;
          case 112: builder.req_float(ProtoAdapter.Companion.getFLOAT().decode(reader)); break;
          case 113: builder.req_double(ProtoAdapter.Companion.getDOUBLE().decode(reader)); break;
          case 114: builder.req_string(ProtoAdapter.Companion.getSTRING().decode(reader)); break;
          case 115: builder.req_bytes(ProtoAdapter.Companion.getBYTES().decode(reader)); break;
          case 116: {
            try {
          ...
          case 202: builder.rep_uint32.add(ProtoAdapter.Companion.getUINT32().decode(reader)); break;
          case 203: builder.rep_sint32.add(ProtoAdapter.Companion.getSINT32().decode(reader)); break;
          case 204: builder.rep_fixed32.add(ProtoAdapter.Companion.getFIXED32().decode(reader)); break;
          case 205: builder.rep_sfixed32.add(ProtoAdapter.Companion.getSFIXED32().decode(reader)); break;
          case 206: builder.rep_int64.add(ProtoAdapter.Companion.getINT64().decode(reader)); break;
          case 207: builder.rep_uint64.add(ProtoAdapter.Companion.getUINT64().decode(reader)); break;
          case 208: builder.rep_sint64.add(ProtoAdapter.Companion.getSINT64().decode(reader)); break;
          case 209: builder.rep_fixed64.add(ProtoAdapter.Companion.getFIXED64().decode(reader)); break;
          case 210: builder.rep_sfixed64.add(ProtoAdapter.Companion.getSFIXED64().decode(reader)); break;
          case 211: builder.rep_bool.add(ProtoAdapter.Companion.getBOOL().decode(reader)); break;
          case 212: builder.rep_float.add(ProtoAdapter.Companion.getFLOAT().decode(reader)); break;
          case 213: builder.rep_double.add(ProtoAdapter.Companion.getDOUBLE().decode(reader)); break;
          case 214: builder.rep_string.add(ProtoAdapter.Companion.getSTRING().decode(reader)); break;
          case 215: builder.rep_bytes.add(ProtoAdapter.Companion.getBYTES().decode(reader)); break;
          case 216: {
            try {
          ...
          case 302: builder.pack_uint32.add(ProtoAdapter.Companion.getUINT32().decode(reader)); break;
          case 303: builder.pack_sint32.add(ProtoAdapter.Companion.getSINT32().decode(reader)); break;
          case 304: builder.pack_fixed32.add(ProtoAdapter.Companion.getFIXED32().decode(reader)); break;
          case 305: builder.pack_sfixed32.add(ProtoAdapter.Companion.getSFIXED32().decode(reader)); break;
          case 306: builder.pack_int64.add(ProtoAdapter.Companion.getINT64().decode(reader)); break;
          case 307: builder.pack_uint64.add(ProtoAdapter.Companion.getUINT64().decode(reader)); break;
          case 308: builder.pack_sint64.add(ProtoAdapter.Companion.getSINT64().decode(reader)); break;
          case 309: builder.pack_fixed64.add(ProtoAdapter.Companion.getFIXED64().decode(reader)); break;
          case 310: builder.pack_sfixed64.add(ProtoAdapter.Companion.getSFIXED64().decode(reader)); break;
          case 311: builder.pack_bool.add(ProtoAdapter.Companion.getBOOL().decode(reader)); break;
          case 312: builder.pack_float.add(ProtoAdapter.Companion.getFLOAT().decode(reader)); break;
          case 313: builder.pack_double.add(ProtoAdapter.Companion.getDOUBLE().decode(reader)); break;
          case 316: {
            try {
          ...
          case 401: builder.default_int32(ProtoAdapter.Companion.getINT32().decode(reader)); break;
          case 402: builder.default_uint32(ProtoAdapter.Companion.getUINT32().decode(reader)); break;
          case 403: builder.default_sint32(ProtoAdapter.Companion.getSINT32().decode(reader)); break;
          case 404: builder.default_fixed32(ProtoAdapter.Companion.getFIXED32().decode(reader)); break;
          case 405: builder.default_sfixed32(ProtoAdapter.Companion.getSFIXED32().decode(reader)); break;
          case 406: builder.default_int64(ProtoAdapter.Companion.getINT64().decode(reader)); break;
          case 407: builder.default_uint64(ProtoAdapter.Companion.getUINT64().decode(reader)); break;
          case 408: builder.default_sint64(ProtoAdapter.Companion.getSINT64().decode(reader)); break;
          case 409: builder.default_fixed64(ProtoAdapter.Companion.getFIXED64().decode(reader)); break;
          case 410: builder.default_sfixed64(ProtoAdapter.Companion.getSFIXED64().decode(reader)); break;
          case 411: builder.default_bool(ProtoAdapter.Companion.getBOOL().decode(reader)); break;
          case 412: builder.default_float(ProtoAdapter.Companion.getFLOAT().decode(reader)); break;
          case 413: builder.default_double(ProtoAdapter.Companion.getDOUBLE().decode(reader)); break;
          case 414: builder.default_string(ProtoAdapter.Companion.getSTRING().decode(reader)); break;
          case 415: builder.default_bytes(ProtoAdapter.Companion.getBYTES().decode(reader)); break;
          case 416: {
            try {
          ...
          case 1001: builder.ext_opt_int32(ProtoAdapter.Companion.getINT32().decode(reader)); break;
          case 1002: builder.ext_opt_uint32(ProtoAdapter.Companion.getUINT32().decode(reader)); break;
          case 1003: builder.ext_opt_sint32(ProtoAdapter.Companion.getSINT32().decode(reader)); break;
          case 1004: builder.ext_opt_fixed32(ProtoAdapter.Companion.getFIXED32().decode(reader)); break;
          case 1005: builder.ext_opt_sfixed32(ProtoAdapter.Companion.getSFIXED32().decode(reader)); break;
          case 1006: builder.ext_opt_int64(ProtoAdapter.Companion.getINT64().decode(reader)); break;
          case 1007: builder.ext_opt_uint64(ProtoAdapter.Companion.getUINT64().decode(reader)); break;
          case 1008: builder.ext_opt_sint64(ProtoAdapter.Companion.getSINT64().decode(reader)); break;
          case 1009: builder.ext_opt_fixed64(ProtoAdapter.Companion.getFIXED64().decode(reader)); break;
          case 1010: builder.ext_opt_sfixed64(ProtoAdapter.Companion.getSFIXED64().decode(reader)); break;
          case 1011: builder.ext_opt_bool(ProtoAdapter.Companion.getBOOL().decode(reader)); break;
          case 1012: builder.ext_opt_float(ProtoAdapter.Companion.getFLOAT().decode(reader)); break;
          case 1013: builder.ext_opt_double(ProtoAdapter.Companion.getDOUBLE().decode(reader)); break;
          case 1014: builder.ext_opt_string(ProtoAdapter.Companion.getSTRING().decode(reader)); break;
          case 1015: builder.ext_opt_bytes(ProtoAdapter.Companion.getBYTES().decode(reader)); break;
          case 1016: {
            try {
          ...
          case 1101: builder.ext_rep_int32.add(ProtoAdapter.Companion.getINT32().decode(reader)); break;
          case 1102: builder.ext_rep_uint32.add(ProtoAdapter.Companion.getUINT32().decode(reader)); break;
          case 1103: builder.ext_rep_sint32.add(ProtoAdapter.Companion.getSINT32().decode(reader)); break;
          case 1104: builder.ext_rep_fixed32.add(ProtoAdapter.Companion.getFIXED32().decode(reader)); break;
          case 1105: builder.ext_rep_sfixed32.add(ProtoAdapter.Companion.getSFIXED32().decode(reader)); break;
          case 1106: builder.ext_rep_int64.add(ProtoAdapter.Companion.getINT64().decode(reader)); break;
          case 1107: builder.ext_rep_uint64.add(ProtoAdapter.Companion.getUINT64().decode(reader)); break;
          case 1108: builder.ext_rep_sint64.add(ProtoAdapter.Companion.getSINT64().decode(reader)); break;
          case 1109: builder.ext_rep_fixed64.add(ProtoAdapter.Companion.getFIXED64().decode(reader)); break;
          case 1110: builder.ext_rep_sfixed64.add(ProtoAdapter.Companion.getSFIXED64().decode(reader)); break;
          case 1111: builder.ext_rep_bool.add(ProtoAdapter.Companion.getBOOL().decode(reader)); break;
          case 1112: builder.ext_rep_float.add(ProtoAdapter.Companion.getFLOAT().decode(reader)); break;
          case 1113: builder.ext_rep_double.add(ProtoAdapter.Companion.getDOUBLE().decode(reader)); break;
          case 1114: builder.ext_rep_string.add(ProtoAdapter.Companion.getSTRING().decode(reader)); break;
          case 1115: builder.ext_rep_bytes.add(ProtoAdapter.Companion.getBYTES().decode(reader)); break;
          case 1116: {
            try {
          ...
          case 1201: builder.ext_pack_int32.add(ProtoAdapter.Companion.getINT32().decode(reader)); break;
          case 1202: builder.ext_pack_uint32.add(ProtoAdapter.Companion.getUINT32().decode(reader)); break;
          case 1203: builder.ext_pack_sint32.add(ProtoAdapter.Companion.getSINT32().decode(reader)); break;
          case 1204: builder.ext_pack_fixed32.add(ProtoAdapter.Companion.getFIXED32().decode(reader)); break;
          case 1205: builder.ext_pack_sfixed32.add(ProtoAdapter.Companion.getSFIXED32().decode(reader)); break;
          case 1206: builder.ext_pack_int64.add(ProtoAdapter.Companion.getINT64().decode(reader)); break;
          case 1207: builder.ext_pack_uint64.add(ProtoAdapter.Companion.getUINT64().decode(reader)); break;
          case 1208: builder.ext_pack_sint64.add(ProtoAdapter.Companion.getSINT64().decode(reader)); break;
          case 1209: builder.ext_pack_fixed64.add(ProtoAdapter.Companion.getFIXED64().decode(reader)); break;
          case 1210: builder.ext_pack_sfixed64.add(ProtoAdapter.Companion.getSFIXED64().decode(reader)); break;
          case 1211: builder.ext_pack_bool.add(ProtoAdapter.Companion.getBOOL().decode(reader)); break;
          case 1212: builder.ext_pack_float.add(ProtoAdapter.Companion.getFLOAT().decode(reader)); break;
          case 1213: builder.ext_pack_double.add(ProtoAdapter.Companion.getDOUBLE().decode(reader)); break;
          case 1216: {
            try {
    ...
    public AllTypes redact(AllTypes value) {
      ...
      Internal.INSTANCE.redactElements(builder.rep_nested_message, NestedMessage.ADAPTER);
      Internal.INSTANCE.redactElements(builder.map_string_message, NestedMessage.ADAPTER);
      ...
      Internal.INSTANCE.redactElements(builder.ext_rep_nested_message, NestedMessage.ADAPTER);
      Internal.INSTANCE.redactElements(builder.ext_map_string_message, NestedMessage.ADAPTER);
      builder.clearUnknownFields();
      return builder.build();
    }
  }
